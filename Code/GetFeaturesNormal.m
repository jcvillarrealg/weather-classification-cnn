...
models1 = [string('bvlc_googlenet'),string('placesCNN'),string('ResNet50')];
models2=[string('ResNet101'),string('ResNet152'),string('VGG_CNN_F'),string('VGG_CNN_M')];
models3 = [string('VGG_CNN_S'),string('VGGNet16'),string('VGGNet19') ];
models = models3;
...
features_base_dir = '../../../DissertationDevelopment/weather-classification-cnn/featuresNormal/';
